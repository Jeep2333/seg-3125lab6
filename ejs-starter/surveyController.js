...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        var webpage = readData("webpage");
        var experience = readData("experience");
        var favorite = readData("favorite");
        var recommend = readData("recommend");
        var improve = readData("improve");
        var gender = readData("gender");
        res.render('showResults', {results: [webpage, experience, favorite, recommend, improve, gender]});
        console.log([webpage, experience, favorite, recommend, improve, gender]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key === "improve") && (json[key].length === 2)){
